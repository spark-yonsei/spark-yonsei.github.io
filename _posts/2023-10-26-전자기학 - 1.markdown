...
$$ \bar{B}=\bar{F_{1}}\left ( \bar{E},\frac{\partial \bar{E}}{\partial t},\cdots ,\bar{H},\frac{\partial \bar{H}}{\partial t},\cdots,\left| \bar{E}\right|^{2},\left| \bar{E}\right|^{3},\cdots  \right )$$<br>
$$\bar{D}=f$$<br>
$$\bar{J}=f$$<br>
